...
class DenseEmbeddingLayer(Layer):
    def __init__(self, embedding_size, init_std, embedding_l2_reg=0.0, seed=1024):
...
class SENETLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        self.output_embedding_size = self.output_embedding_size if self.output_embedding_size else self.embedding_size

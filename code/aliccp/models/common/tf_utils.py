...
def get_top_inputs_embeddings_old(feature_columns, features, embeddings, feature_importance_metric="dimension",
...
def get_top_inputs_embeddings(feature_columns, features, embeddings, feature_importance_metric="dimension",
    ...
    print(embeddings)
    print(top_inputs)
    # batch_size = embeddings.get_shape()[0]
    # print(batch_size)
    # top_inputs_tile = [tf.tile(x, [batch_size, 1]) for x in top_inputs]

    # print(top_inputs_tile)
